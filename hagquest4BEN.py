...
def manTalker(name,description,exits,items,command,room):
    ...
    if room.name == "Backyard":
        if vacuum in inventory:
            print "The man waves to you. \"Thanks and good luck!\" he shouts."
        elif talkerCounter == 0:
            print """The man scowls at you. \"What do you want?? You're one of the hag's cronies, aren'tcha?
            ...
            print """The man scoffs at you. \"Didn't I already tell you to get lost? What, are you after my
            ...
            print "The man doesn't say anything, just flips you off. He definitely needs a friend.\n"
    else:
        print "There's no one here to talk to. You mumble to yourself a little.\n"

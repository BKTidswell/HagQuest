...
def enter(room):
    ...
    roomparse(room.name,room.description,room.exits,room.items,room)
...
def item_user(name,description,exits,items,command,room):
    ...
    print "You used the %s on the %s. But. Nothing happened..." % (usingItem.name,targetItem.name)
...
ladder = Item("Ladder", "Hag's ladder. The rungs spell out H A G. Not convenient, but definitely stylish.",
    True,{})
...
dishes = Item("Dishes", "Some dirty dishes.",
    False,{potion:[usage_descriptor,["You get your elbow grease on and clean off the dishes with the potion.\n","eh"],
...
rug = Item("Rug", "It's like a shag carpet, if the shag were dust. ... What I'm trying to say is it's incredibly dusty.\n",
...
pool = Item("Pool", "The pool is filled with acid. There's something at the bottom, but you'd need to clean the acid away first.",
    False,{potion:[usage_descriptor,["You clean all the acid away","eh"],
                   ...
                   item_description_changer,["An empty pool with a rusty hammer at the bottom.","Pool"]]})

elemental = Item("Man", "He appears to be a large, blue man who seems thoroughly unhappy. He's dressed in a bathrobe.",
    False,{spider_box:[usage_descriptor,["You give the man the terrarium with the spider. He seems overjoyed and thanks you profusely. He disappears inside, and returns with a big vacuum which he tosses out the window."],
                   item_adder,[vacuum,"Backyard"],
...
telephone = Item("Phone", "It's the hag's escape-proof telephone. Rotary, of course."+
    ...
    full of what look like noxious magical ingredients. Only one of the drawers
    looks like it's in working condition. Against the wall is a grimy phone,
...
[watch,knife,dishes,trash,telephone,fridge,ceiling_fan,drawer])
...
inventory = [sword,telephone_book]
...
def roomparse(name,description,exits,items,room):
